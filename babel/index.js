...
function FeaturedDevices() {
  // TODO: вынести все компоненты и юзать потом useЬуьщ
  const ref = React.useRef();
...
root.render( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Header, null), /*#__PURE__*/React.createElement(Main, null, /*#__PURE__*/React.createElement(FeaturedDevices, null))));
// }, 100);